...
public class EscolaDAO {
	...
	public EscolaDAO() {
		...
		Disciplina disciplina = new Disciplina(123, "UML 1", curso);
		...
		Aluno aluno = new Aluno(11, "Joao da Silva", data, true,
				EstadoCivil.solteiro, curso, telefones,20);
	...
	public void removeTurma(int codTurma, int ano, int semestre)
		...
		turmas.remove(codTurma, ano, semestre);
	}
	...
	public void removeInscricao(int matricula, int codigo, int ano, int semestre)
		...
		inscricoes.remove(matricula, codigo, ano, semestre);
	}
